    ...
    <>
      <div>
        ...
        <p className={styles.paragraph}>
          Currently, the site includes all closed collegiate tournaments in the seasons from 2011-2012 to 2021-2022 that have posted stats, with the exception of
          those that only posted stats on Neg5 or that posted stats without a
          Scoreboard page. Open tournaments that were primarily composed of closed collegiate teams, as well as Chicago Open, were also included.
        </p>
